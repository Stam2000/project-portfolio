...
const DesignHeader = ()=>{
    ...
    return(
        ...
        {/* Right */}
          ...
          <MySvg className="z-0 absolute h-8 top-[15%] -left-[10%] md:top-[10%] md:left-1/2 " primaryColor="white" secondaryColor="#bcbcbc" tertiaryColor="#dcdcdc" />
          <MySvg4 className="z-0 absolute h-16 top-[29%] opacity-75 right-[30%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          {/* Group 1*/}
          ...
          <MySvg5 className="z-0 absolute h-16 top-[7%]  -right-[5%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg6 className="z-0 absolute h-5 top-[30%]  right-[1%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg className="z-0 absolute h-3 top-[38%]  right-[1%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg2 className="z-0 absolute h-2 top-[28%]  right-[1%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg5 className="z-0 absolute h-3 top-[30%]  right-[10%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          {/*Group 1 end*/}
          ...
          <MySvg className="z-0 absolute h-8  bottom-[40%]  right-[5%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg3 className="z-0 absolute md:h-20 h-16  bottom-[7%]  right-[5%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          {/*Group 2 */}
          ...
          <MySvg5 className="z-0 absolute h-12  bottom-[30%] opacity-80  right-[25%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="white" />
          <MySvg6 className="z-0 absolute h-8  bottom-[18%] opacity-80  right-[35%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg4 className="z-0 absolute h-8  bottom-[36%] opacity-80  left-[0%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg2 className="z-0 absolute h-3  bottom-[38%] opacity-80  right-[35%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg3 className="z-0 absolute h-5 bottom-[25%] left-[20%] md:bottom-[28%] opacity-80  md:right-[40%] " primaryColor="white" secondaryColor="#eaeaea" tertiaryColor="#bcbcbc" />
          {/*Group 3 */}
          ...
          <MySvg2 className="z-0 absolute h-8  top-[1%]  right-[20%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg className="z-0 absolute h-4  top-[20%]  right-[16%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <MySvg4 className="z-0 absolute h-6  bottom-[1%] opacity-50 right-[30%] " primaryColor="white" secondaryColor="#dcdcdc" tertiaryColor="#bcbcbc" />
          <div className="absolute top-[32%] right-[20%] rounded-full bg-gray-100 h-[20px] w-[20px] " />
        {/* Right end */}  

          {/*CARREE gris tout en haut du cercle Input */}
          <div className={`absolute top-[20%] left-[38%]  md:top-[14%] md:left-[36%] rounded-2xl rotate-[35deg] border-[10px] border-white md:border-[#bcbcbc] h-[60px] w-[60px]`} />
          {/*Cercle*/}
          ...
          <div className={`absolute top-[11%] left-[7%] md:top-[8%] md:left-[54%] rounded-full bg-white h-[20px] w-[20px]`} />
          {/*CARREE*/}
          ...
          <div className={`absolute bottom-[45%] left-[20%] md:bottom-[51%] md:left-[42%] rounded-full bg-white h-[10px] w-[10px]`} />
          {/*Cercle*/}
          {/* <div className={`absolute bottom-[25%] right-[20%] md:left-[56%] rounded-full bg-slate-500 h-[7px] w-[7px]`} /> */}
          <div className={`absolute bottom-[25%] right-[20%] md:left-[56%] rounded-full bg-slate-50 h-[7px] w-[7px]`} />
          {/*Cercle*/}
          {/* <div className={`absolute bottom-[18%] left-[20%]  md:bottom-[29%] md:left-[40%] rounded-full bg-slate-300 h-[28px] w-[28px]`} /> */}
          <div className={`absolute bottom-[12%] left-[10%]  md:bottom-[29%] md:left-[40%] rounded-full bg-white/20 h-[28px] w-[28px]`} />
          {/*Cercle bottom input*/}
